...
err_0 = np.load('Data/OT/a_priori/err/L_infty_OT_0.0.npy')
err_1 = np.load('Data/OT/a_priori/err/L_infty_OT_0.4.npy')
err_2 = np.load('Data/OT/a_priori/err/L_infty_OT_0.667.npy')
err_3 = np.load('Data/OT/a_priori/err/L_infty_OT_0.8.npy')
err_4 = np.load('Data/OT/a_priori/err/L_infty_OT_0.933.npy')
