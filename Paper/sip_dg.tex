...
%\addlegendentry{uniform};
\addplot+[color=green, mark = diamond]
	table[x=dof,y=error, col sep=comma]{Data/Test1/h-adaptive/MS/href_Linfty_0.99.csv};
%\addlegendentry{h-refinement};
\addplot+[color=red, mark = otimes]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorLinfty_0.67.csv};
%\addlegendentry{a-priori};
...
\draw[dotted,green] (100000,0.00025) -- (1000000,0.00006);
\node at (500000,0.0002) {$0.67$};
\draw[dotted,red] (100000,0.00005) -- (1000000,0.000005);
...
%\addlegendentry{unstructured};
\addplot+[color=green, mark = star]
	table[x=dof,y=error, col sep=comma]{Data/Test2/h-adaptive/href_Linfty_0.0.csv};
...
\draw[dotted,green] (100000,0.0025) -- (1000000,0.001);
\node at (500000,0.0008) {$0.5$};
\draw[dotted,red] (100000,0.0001) -- (1000000,0.00001);
\node at (500000,0.000009) {$1.0$};    
\end{axis}
\end{tikzpicture}
}
\caption{Asymptotic convergence rates for different adaptive strategies. Note that the rate of convergence is optimal for h-refinement and the OT strategy ($\gamma = 0.7$) in the $\leb{2}$ norm. The latter yields higher accuracy and convergence rate in case of $\leb{\infty}$ norm.}
\end{figure}
