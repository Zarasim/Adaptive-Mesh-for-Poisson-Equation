...
\begin{figure}[h!]\label{fig:r-adaptive_meshes}
    ...
    \includegraphics[width=0.4\linewidth]{Images/Test1/r-adaptive/u_posteriori_0_99.png}
  }
 \subfloat[\label{fig:u_posteriori_0.99}Mesh adapted with a-posteriori monitor function ($\hat{\beta} = 0.99$).]{
    \includegraphics[width=0.4\linewidth]{Images/Test1/r-adaptive/u_posteriori_0_0.png}
  }
...
\addlegendentry{$\gamma = 0.67$};
\addplot+[color = magenta,  mark = triangle]
	table[x=dof,y=Q, col sep=comma]{Data/Skewness/skewness_0_81.csv};
\addlegendentry{$\gamma = 0.815$};        
\addplot+[color = yellow,  mark = triangle]
	table[x=dof,y=Q, col sep=comma]{Data/Skewness/skewness_0_9.csv};
