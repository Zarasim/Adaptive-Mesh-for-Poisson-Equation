...
\item The nodes of OT mesh for the L-shaped domain are equidistant to the origin () independently on the angular variable. This observation further suggests that in the neighboorhood of the origin the problem can be considered as 1D.
