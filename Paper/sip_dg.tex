...
\addplot+[color=yellow, mark = triangle] 
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_L2/measure_L2_0.9.csv};
\addlegendentry{$\gamma = 0.9$};
\end{axis}
\end{tikzpicture}
}\\
...
\addplot+[color=black, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_Linfty/measure_Linfty_0.47.csv};
%\addlegendentry{$\gamma = 0.47$}; 
\addplot+[color=red, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_Linfty/measure_Linfty_0.53.csv};
%\addlegendentry{$\gamma = 0.53$}; 
\addplot+[color=green, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_Linfty/measure_Linfty_0.59.csv};
%\addlegendentry{$\gamma = 0.59$}; 
\addplot+[color=blue, mark = triangle]
...
%\addlegendentry{$\gamma = 0.78$}; 
\addplot+[color=orange, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_Linfty/measure_Linfty_0.84.csv};
%\addlegendentry{$\gamma = 0.84$}; 
\addplot+[color=yellow, mark = triangle] 
table[x=dist,y=measure, col sep=comma]{Data/Test1/OT/measure_Linfty/measure_Linfty_0.9.csv};
%\addlegendentry{$\gamma = 0.9$};
\end{axis}
\end{tikzpicture}
}
...
\paragraph{OT mesh from  a-posteriori monitor function}

Here we propose an alternative approach to obtain the OT mesh using the a-posterior indicator $\eta_{K}$ as the monitor function $m(r) = A + Br^{C}$. The three parameters are found by fitting the values of the measure $\eta_{K}/\sqrt{|K|}$ in the neighbourhood of the the origin. The values are here computed using the mesh generated by the Winslow' method.

% plot the value of eta_k/|K| vs r using tikzpicture

\begin{figure}[h!]\label{tikz:monitor_posteriori}
\centering
\subfloat[{\label{fig:measure_L2}} (A = 2.19 $\times 10^{−5}$, B = 4.9 $\times 10^{−6}$, C = -1.22)]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\subfloat[{\label{fig:measure_Linfty}}]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
    ...
    % \draw[ultra thick,black] (0.002,0.005) -- (0.008,0.00047);
\addplot+[color=cyan, mark = triangle]
table[x=r,y=m, col sep=comma]{Data/Test1/OT/monitor_measure_linfty.csv};
%\addlegendentry{$Crack: C = -1.49$};
%\draw[thick,black] (0.0035,0.0135) -- (0.008,0.00134);        
\end{axis}
\end{tikzpicture}
}
\caption{a-posterioi measure with $\leb{2}$ and $\leb{\infty}$ upper bound}
\end{figure}

\begin{figure}
\centering
\subfloat[{\label{fig:error_L2_posteriori}}]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorL2_0.53.csv};
\addlegendentry{a-priori ($\gamma = 0.53$)};
\end{axis}
\end{tikzpicture}
}
\subfloat[{\label{fig:error_Linfty_posteriori}}]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorLinfty_0.67.csv};
\addlegendentry{a-priori ($\gamma = 0.67$)};
\end{axis}
\end{tikzpicture}
}\\
\subfloat[{\label{fig:q_posteriori}}]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\subfloat[{\label{fig:mu_posteriori}}]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\caption{Comparison of error and quality measure for a-priori and a-posteriori OT mesh}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.385\linewidth]{Images/Test1/OT/u_OT_zoom.png}
  }
...
\end{axis}
\end{tikzpicture}
\caption{Asymptotic convergence rates for different adaptive strategies.}
\end{figure}
...
\subfloat[{\label{fig:crack_OT_zoom}}
    ...
    \includegraphics[scale=0.198]{Images/Test2/r-adaptive/OT_zoom.png}
  }
\end{figure}
...
\addlegendentry{$\gamma = 0.84$}; 
\addplot+[color=yellow, mark = triangle] 
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_L2/measure_L2_0.9.csv};
\addlegendentry{$\gamma = 0.9$};
\end{axis}
\end{tikzpicture}
}\\
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % \draw[ultra thick,black] (0.002,0.005) -- (0.008,0.00047);
\addplot+[color=black, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.47.csv};
%\addlegendentry{$\gamma = 0.47$}; 
\addplot+[color=red, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.53.csv};
%\addlegendentry{$\gamma = 0.53$}; 
\addplot+[color=green, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.59.csv};
%\addlegendentry{$\gamma = 0.59$}; 
\addplot+[color=blue, mark = triangle]
...
%\addlegendentry{$\gamma = 0.71$}; 
\addplot+[color=magenta, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.78.csv};
%\addlegendentry{$\gamma = 0.78$}; 
\addplot+[color=orange, mark = triangle]
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.84.csv};
%\addlegendentry{$\gamma = 0.84$}; 
\addplot+[color=yellow, mark = triangle] 
table[x=dist,y=measure, col sep=comma]{Data/Test2/OT/measure_Linfty/measure_Linfty_0.9.csv};
%\addlegendentry{$\gamma = 0.9$};
\end{axis}
\end{tikzpicture}
}
...
Here we propose an alternative approach to obtain the OT-mesh using the a-posterior indicator $\eta_{K}$ as the monitor function $m(r) = A + Br^{C}$. The three parameters are found by fitting the values of the measure $\eta_{K}/\sqrt{|K|}$ in the neighbourhood of the the origin.

% plot the value of eta_k/|K| vs r using tikzpicture

\begin{figure}[h!]\label{tikz:monitor_posteriori}
\centering
\subfloat[{\label{measure_L2}} (A = 5.91 $\times 10^{-4}$, B = 7.89$\times 10^{-6}$, C = -0.94)]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\draw[ultra thick,black] (0.0035,0.0135) -- (0.008,0.00134);        
\end{axis}
\end{tikzpicture}
}
\subfloat[{\label{measure_Linfty}}]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addplot+[color=cyan, mark = triangle]
table[x=r,y=m, col sep=comma]{Data/Test2/OT/monitor_measure_linfty.csv};
%\draw[ultra thick,black] (0.0035,0.0135) -- (0.008,0.00134);        
\end{axis}
\end{tikzpicture}
}
...
%\addlegendentry{unstructured mesh ($\gamma = 0.0$)}; 
\addplot+[color=red,mark = triangle]
        table[x=dof,y=error, col sep=comma]{Data/Test2/OT/a_posteriori/errorL2.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test2/OT/a_priori/errorL2_0.6.csv};
\addlegendentry{a-priori ($\gamma = 0.6$)};
\end{axis}
\end{tikzpicture}
}
\subfloat[{\label{fig:error_Linfty_posteriori}}]{  
...
%\addlegendentry{unstructured mesh ($\gamma = 0.0$)}; 
\addplot+[color=red,mark = triangle]
        table[x=dof,y=error, col sep=comma]{Data/Test2/OT/a_posteriori/errorLinfty.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test2/OT/a_priori/errorLinfty_0.75.csv};
\addlegendentry{a-priori ($\gamma = 0.75$)};
\end{axis}
\end{tikzpicture}
}\\
\centering
...
%\addlegendentry{unstructured ($\gamma = 0.0$)};
\addplot+[color=red,mark = triangle]
	table[x=dof,y=q, col sep=comma]{Data/Test2/OT/a_posteriori/stat.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=q, col sep=comma]{Data/Test2/OT/a_priori/stat_0.6.csv};
\addlegendentry{a-priori ($\gamma = 0.6$)};
...
%\addplot+[color=black,mark = triangle]
%        table[x=dof,y=mu, col sep=comma]{Data/Test2/OT/a_priori/stat_0.0.csv};
%\addlegendentry{unstructured ($\gamma = 0.0$)};
\addplot+[color=red,mark = triangle]
	table[x=dof,y=mu, col sep=comma]{Data/Test2/OT/a_posteriori/stat.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=mu, col sep=comma]{Data/Test2/OT/a_priori/stat_0.6.csv};
\addlegendentry{a-priori ($\gamma = 0.6$)};
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.4\linewidth]{Images/Test2/OT/u_OT.png}
  }
     \subfloat[\label{fig:mesh_posteriori_crack_zoom} OT mesh for crack domain (zoom).]{
    \includegraphics[width=0.382\linewidth]{Images/Test2/OT/u_OT_zoom.png}
  }
\caption{Solution of eq.\eqref{eq:poisson_corner} for OT mesh with a-posteriori monitor function.}  
\label{fig:crack_OT_mesh_posteriori}
\end{figure}
...
\addplot+[color=green, mark = diamond]
table[x=dof,y=error, col sep=comma]{Data/Test2/OT/a_priori/errorL2_0.6.csv};
\addlegendentry{OT a-priori ($\gamma = 0.6$)};
\addplot+[color=orange, mark = square]
