...
\paragraph{OT mesh for different $gammas$}
...
\addplot+[color=blue,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorL2_0.5.csv};
...
\addlegendentry{$\gamma = 0.33$};        
\addplot+[color=blue,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorLinfty_0.5.csv};
\addlegendentry{$\gamma = 0.5$};
\addplot+[color=cyan,mark = triangle]
...
\caption{ $\leb{2}$ and $\leb{\infty}$ error for OT mesh for different $\gamma$}
\end{figure}


The quality of the resulting mesh is expressed in terms of mesh condition and shape regularity:


\begin{figure}[h!]\label{tikz:OT_gamma_quality_mesh}
\centering
...
\addlegendentry{$\gamma = 0.33$};        
\addplot+[color=blue,mark = triangle]
	table[x=dof,y=q, col sep=comma]{Data/Test1/OT/a_priori/stat_0.5.csv};
\addlegendentry{$\gamma = 0.5$};
\addplot+[color=cyan,mark = triangle]
...
\addlegendentry{$\gamma = 0.33$};        
\addplot+[color=blue,mark = triangle]
	table[x=dof,y=mu, col sep=comma]{Data/Test1/OT/a_priori/stat_0.5.csv};
\addlegendentry{$\gamma = 0.5$};
\addplot+[color=cyan,mark = triangle]
...
\caption{mesh condition and shape regularity for OT mesh for different $\gamma$}
\end{figure}


%% Include pictures showing subsequent OT refinement for L-shaped domain with solution u
...
% plot the value of eta_k/|K| vs r using tikzpicture
...
\addplot+[color=red, mark = triangle]
	table[x=r,y=m, col sep=comma]{Data/Test1/OT/monitor_measure.csv};
\addlegendentry{$L-shaped: C = -1.22$};
\draw[thick,black] (0.002,0.005) -- (0.008,0.00047);        
%\addplot+[color=cyan, mark = triangle]
%	table[x=r,y=m, col sep=comma]{Data/Test2/OT/monitor_measure.csv};
%\addlegendentry{$Crack: C = -1.49$};
%\draw[thick,black] (0.0035,0.0135) -- (0.008,0.00134);        
\end{axis}
\end{tikzpicture}
\caption{Values of the a-posteriori monitor function near the re-entrant corner.}
\end{figure}


\begin{figure}[h!]\label{tikz:OT_posteriori_error}
\centering
\subfloat[{\label{fig:error_L2_posteriori}} Comparison of $\leb{2}$ error for OT mesh obtained with a-priori and a-posteriori monitor function]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addplot+[color=black,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorL2_0.0.csv};
\addlegendentry{unstructured mesh ($\gamma = 0.0$)}; 
\addplot+[color=red,mark = triangle]
        table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_posteriori/errorL2.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorL2_0.5.csv};
\addlegendentry{a-priori ($\gamma = 0.5$)};
\end{axis}
\end{tikzpicture}
}
\hfill
\subfloat[{\label{fig:error_Linfty_posteriori}} Comparison of $\leb{\infty}$ error for OT mesh obtained with a-priori and a-posteriori monitor function]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addlegendentry{unstructured mesh ($\gamma = 0.0$)}; 
\addplot+[color=red,mark = triangle]
        table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_posteriori/errorLinfty.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=error, col sep=comma]{Data/Test1/OT/a_priori/errorLinfty_0.5.csv};
\addlegendentry{a-priori ($\gamma = 0.5$)};
...
\begin{figure}[h!]\label{tikz:OT_posteriori_quality_mesh}
\centering
\subfloat[{\label{fig:q_posteriori}} Comparison of the mesh condition between OT mesh obtained with a-posteriori and a-priori monitor function]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addplot+[color=black,mark = triangle]
        table[x=dof,y=q, col sep=comma]{Data/Test1/OT/a_priori/stat_0.0.csv};
\addlegendentry{unstructured ($\gamma = 0.0$)};
\addplot+[color=red,mark = triangle]
	table[x=dof,y=q, col sep=comma]{Data/Test1/OT/a_posteriori/stat.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=q, col sep=comma]{Data/Test1/OT/a_priori/stat_0.5.csv};
\addlegendentry{a-priori ($\gamma = 0.5$)};               
...
\hfill
\subfloat[{\label{fig:mu_posteriori}} Comparison of the quality measure between OT mesh obtained with a-posteriori and a-priori monitor function]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\addlegendentry{unstructured ($\gamma = 0.0$)};
\addplot+[color=red,mark = triangle]
	table[x=dof,y=mu, col sep=comma]{Data/Test1/OT/a_posteriori/stat.csv};
\addlegendentry{a-posteriori};
\addplot+[color=green,mark = triangle]
	table[x=dof,y=mu, col sep=comma]{Data/Test1/OT/a_priori/stat_0.5.csv};
\addlegendentry{a-priori ($\gamma = 0.5$)};               
...
\caption{mesh condition and shape regularity for OT mesh for a-posteriori and a-priori monitor function}
\end{figure}


% show qualitatively the 2 different meshes in a figure 

%\begin{figure}[h!]
%    \centering
%      \subfloat[\label{fig:mesh_posteriori_L} OT Mesh for L-shaped domain.]{
%    \includegraphics[width=0.4\linewidth]{Images/Test1/OT/mesh_posteriori.png}
%  }
%     \subfloat[\label{fig:mesh_posteriori_crack} OT Mesh for crack domain.]{
%    \includegraphics[width=0.4\linewidth]{Images/Test2/OT/mesh_posteriori.png}
%  }
%\caption{Solution of eq.\eqref{eq:poisson_corner} for a-posteriori monitor function.}  
%\label{fig:OT_mesh_posteriori}
%\end{figure}
...
\addplot+[color=green, mark = diamond]
table[x=dof,y=error, col sep=comma]{Data/Test2/OT/OT_ref.csv};
\addlegendentry{OT};
\addplot+[color=orange, mark = square]
...
\begin{figure}[h!]
  \subfloat[{\label{fig:1-a}}
  The mesh condition plotted against the dimension of the Galerkin space for different meshes on the L-shaped domain. ]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
table[x=dof,y=q, col sep=comma]{Data/Test1/OT/q_posteriori.csv};
\addlegendentry{OT mesh (a-posteriori)};
\addplot+[color = cyan, mark=star]
...
\hfill
\subfloat[{\label{fig:1-b}} The shape regularity constant plotted against the dimension of the Galerkin space for different meshes on the L-shaped domain.]
{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
...
\addplot+[color = red, mark=diamond]
	table[x=dof,y=mu, col sep=comma]{Data/Test1/OT/mu_posteriori.csv};
\addplot+[color = cyan, mark=star]
...
\end{axis}
\end{tikzpicture}}\\
 \subfloat[{\label{fig:3-a}}
    The mesh condition plotted against the dimension of the Galerkin space for different meshes on the crack domain. 
  ]{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
...
\addplot+[color = red, mark=diamond]
table[x=dof,y=q, col sep=comma]{Data/Test2/OT/q_posteriori.csv};
\addplot+[color = cyan, mark=star]
	table[x=dof,y=q, col sep=comma]{Data/Test2/h-adaptive/q_0.0.csv};
%\addlegendentry{h-refinement ($\beta = 0$)};
\addplot+[color = green, mark=diamond]
	table[x=dof,y=q, col sep=comma]{Data/Test2/OT/q.csv};
%\addlegendentry{OT mesh};
\addplot+[color = orange, mark=square]
...
\hfill
\subfloat[{\label{fig:3-b}} The shape regularity constant plotted against the dimension of the Galerkin space for different meshes on the crack domain.]
{
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
...
\addplot+[color = red, mark=diamond]
table[x=dof,y=mu, col sep=comma]{Data/Test2/OT/mu_posteriori.csv};
\addplot+[color = cyan, mark=star]
	table[x=dof,y=mu, col sep=comma]{Data/Test2/h-adaptive/mu_0.0.csv};
%\addlegendentry{h-refinement};
\addplot+[color = green, mark=diamond]
	table[x=dof,y=mu, col sep=comma]{Data/Test2/OT/mu.csv};
%\addlegendentry{OT mesh};
\addplot+[color = orange, mark=square]
