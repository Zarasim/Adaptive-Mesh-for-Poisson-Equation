...
\begin{figure}[h!]\label{fig:_crack_figures}
\centering
...
\centering
\subfloat[{\label{fig:crack_error_gamma_L2}} $\leb{2}$ error for different $\gamma$]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
...
\subfloat[{\label{fig:crack_error_gamma_Linfty}} $\leb{\infty}$ error for different $\gamma$]{  
\begin{tikzpicture}
  \begin{axis}[
      cycle list/Dark2,
      thick,
